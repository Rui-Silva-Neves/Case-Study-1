...
- Key takeaways are: 
  1) Members take shorter, and more frequent rides during the weekday (Mond - Fri) and tipically use the Cyclistic bikes to commute (peaking hours ate at 8h and 17h).
  2) Casual rides take longer, are less frequent and more on weekends (Sat - Sun). Casuals tipically use the Cyclistic bikes leisurely, with peak usage during the day.
  3) Members most popular starting stations are more urban/business/downtown areas whereas casuals' most popular starting stations are more tourist attractions.
